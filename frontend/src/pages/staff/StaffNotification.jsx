...
export default function StaffNotification() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      message: "Paracetamol 500mg is running low on stock. Please update inventory.",
      type: "medicine",
      date: "2025-03-20",
      read: false,
    },
    {
      id: 6,
      title: "New Medicine Delivery",
      message: "A new shipment of medicines has arrived. Please verify and update the inventory.",
      type: "medicine",
      date: "2025-03-18",
      read: true,
    },
