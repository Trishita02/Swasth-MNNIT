...
import {getDoctorNotificationsAPI,markDoctorNotificationAsReadAPI,markAllDoctorNotificationsAsReadAPI} from "../../utils/api.jsx"
...
export default function DoctorNotification() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const data = await getDoctorNotificationsAPI()
